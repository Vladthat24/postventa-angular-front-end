...
@Component({
  selector: 'app-filter-data-range-ymd',
  standalone: true,
  imports: [SharedModule,MomentDateModule],
  templateUrl: './filter-data-range-ymd.component.html',
  styleUrls: ['./filter-data-range-ymd.component.scss'],
  providers:[{provide:MAT_DATE_FORMATS,useValue:MY_DATE_FORMATS}]
})
export class FilterDataRangeYmdComponent implements OnInit,OnChanges {
  @Input() start: string;
  @Input() end: string;
